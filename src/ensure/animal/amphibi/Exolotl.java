...
public class Exolotl extends Amphibi {
   ...
   * @param inputHabitat Menyatakan habitat Animal tersebut. Constructor. Melakukan inisialisasi
   * kelas
   */
  public Exolotl(String inputName, double inputWeight, boolean isTamed, int x, int y,
